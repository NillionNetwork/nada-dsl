...
@pytest.mark.parametrize(
    ...
    [
        (operator.eq, "Equals", {"Secret": {"Boolean": None}}),
        (SecretBoolean.public_equals, "PublicEquals", {"Public": {"Boolean": None}})
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (operator.ge, "GreaterOrEqualThan", {"Secret": {"Boolean": None}}),
        (operator.eq, "Equals", {"Secret": {"Boolean": None}}),
        (SecretInteger.public_equals, "PublicEquals", {"Public": {"Boolean": None}})
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (operator.ge, "GreaterOrEqualThan", {"Secret": {"Boolean": None}}),
        (operator.eq, "Equals", {"Secret": {"Boolean": None}}),
        (SecretUnsignedInteger.public_equals, "PublicEquals", {"Public": {"Boolean": None}})
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (operator.ge, "GreaterOrEqualThan", {"Secret": {"Boolean": None}}),
        (operator.eq, "Equals", {"Secret": {"Boolean": None}}),
        (SecretRational.public_equals, "PublicEquals", {"Public": {"Boolean": None}})
    ],
)
