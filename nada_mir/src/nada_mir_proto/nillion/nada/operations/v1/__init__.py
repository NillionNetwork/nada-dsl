...
class Operation(betterproto.Message):
    ...
    random: "RandomOperation" = betterproto.message_field(7, group="operation")
    ...
    map: "MapOperation" = betterproto.message_field(10, group="operation")
    reduce: "ReduceOperation" = betterproto.message_field(11, group="operation")
    new: "NewOperation" = betterproto.message_field(12, group="operation")
    array_accessor: "ArrayAccessor" = betterproto.message_field(13, group="operation")
    tuple_accessor: "TupleAccessor" = betterproto.message_field(14, group="operation")
    ntuple_accessor: "NtupleAccessor" = betterproto.message_field(15, group="operation")
    object_accessor: "ObjectAccessor" = betterproto.message_field(16, group="operation")
